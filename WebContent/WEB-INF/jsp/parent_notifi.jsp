    		...
    		<table class="table table-striped table-hover table-bordered" style="background-color: white">
	        	...
	        	<tbody>
	        		<c:forEach var="appointment" varStatus="status" items="${appointments}">
					    ...
					    <td class="text-center"><option value ="10"><c:out value="${appointment.sitter.firstName} ${appointment.sitter.lastName}"/></option></td>
					    ...
					    <a class="btn btn-primary btn-block" href="<c:url value='/checkout?appointmentID=${appointments[status.index].id}'/>" >Pay</a>
					    </c:if>
					    <a class="btn btn-primary btn-block" href="<c:url value='/cancelAppointment?appointmentID=${appointments[status.index].id}'/>" >Cancel</a>
					    </td>
					    </tr>
					</c:forEach>
	        	</tbody> 
    ...
    <div class="learn-more">
	  <div class="container">
		<div class="row">
	      <div class="col-md-4">
			<h3>Travel</h3>
			<p>Don't own a car?Just use our very own smart car!</p>
