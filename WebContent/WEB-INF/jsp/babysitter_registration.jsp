...
<form id="regForm" method="post" action="/BabySitterManagement/addSitter">
  <center><h2>Babysitters enter your details</h2></center><br>
  ...
  <div class="tab">
    ...
    <p><input type="date" placeholder="Date of Birth" oninput="this.className = ''" name="dateofBirth" required></p>
  ...
  <div class="tab">
    <p><input type="text" placeholder="Hourly Pay" oninput="this.className = ''" name="hourlypay" required></p>
    <p><input type="text" placeholder="Experience" oninput="this.className = ''" name="experience" required></p>
    <p><input type="textarea" placeholder="Bio" oninput="this.className = ''" name="bio" required></p>
  </div>
